...
public class PageTools {
    ...
    protected void shouldBe (String locatorType, WebElementCondition condition, String locator, Object... args){
        switch (locatorType){
            ...
            case "name":
                ...
                break;
            case "class":
                $(byClassName(locatorFormatter(locator, args))).shouldBe(condition);
                break;
            default:
    ...
    protected void shouldHave (String locatorType, WebElementCondition condition, String locator, Object... args){
        switch (locatorType){
            ...
            case "name":
                ...
                break;
            case "class":
                $(byClassName(locatorFormatter(locator, args))).shouldHave(condition);
                break;
            default:
                throw new IllegalArgumentException("Invalid locator type: " + locatorType);
        }
    ...
    protected void click (String locatorType, String locator, Object... args){
        switch (locatorType){
            ...
            case "name":
                ...
                break;
            case "class":
                $(byClassName(locatorFormatter(locator, args))).click();
                break;
            default:
                throw new IllegalArgumentException("Invalid locator type: " + locatorType);
        }
    ...
    protected void type (String locatorType, String text, String locator, Object... args){
        switch (locatorType){
            ...
            case "name":
                ...
                break;
            case "class":
                $(byClassName(locatorFormatter(locator, args))).append(text);
                break;
            default:
                throw new IllegalArgumentException("Invalid locator type: " + locatorType);
        }
    ...
    protected String getText (String locatorType, WebElementCondition condition, String locator, Object... args){
        switch (locatorType){
            case "xpath":
            ...
            case "class":
                return $(byClassName(locatorFormatter(locator, args))).getText();
            default:
                throw new IllegalArgumentException("Invalid locator type: " + locatorType);
        }
    }
    protected ElementsCollection getElements(String locatorType, String locator, Object... args){
        switch (locatorType){
            ...
            case "class":
                return $$(byClassName(locatorFormatter(locator, args)));
            default:
                throw new IllegalArgumentException("Invalid locator type: " + locatorType);
        }
    }

    protected List<String> getElementsTexts(String locatorType, String locator, Object... args){
        switch (locatorType){
            case "xpath":
            ...
            case "class":
                return $$(byClassName(locatorFormatter(locator, args))).texts() ;
            default:
                throw new IllegalArgumentException("Invalid locator type: " + locatorType);
        }
    }
    ...
    protected boolean isElementCondition(String locatorType, WebElementCondition condition, String locator, Object... args){
        switch (locatorType){
            ...
            case "class":
                return $(byClassName(locatorFormatter(locator, args))).is(condition);
            default:
                throw new IllegalArgumentException("Invalid locator type: " + locatorType);
        }
    }
